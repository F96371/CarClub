...
INSERT INTO `employee` VALUES (2, '林嘉锋', '男', '13556508509', '154813614@qq.com', '青岛农业大学', 20, '0', '201624133119', '000000');
...
INSERT INTO `employee` VALUES (8, '党士麟', '男', '13556502985', '1006403310@qq.com', '青岛农业大学五区101', 20, '0', '201624133128', '000000');
...
-- Records of remind
-- ----------------------------
INSERT INTO `remind` VALUES (1, '2024-06-14', '办理车务', '已完成', 1);
INSERT INTO `remind` VALUES (2, '2017-05-03', '去救援', '未完成', 4);
INSERT INTO `remind` VALUES (3, '2024-06-05', '会员旅行，记得问候', '已完成', 3);
...
-- Records of rescue
-- ----------------------------
INSERT INTO `rescue` VALUES (1, '2024-05-21', '青岛', '救援成功', 2, 3);
INSERT INTO `rescue` VALUES (2, '2024-06-22', '青岛城阳区', '正在救援', 3, 8);
INSERT INTO `rescue` VALUES (3, '2024-06-06', '青岛', '救援成功', 2, 2);
INSERT INTO `rescue` VALUES (4, '2024-03-03', '揭阳', '等待救援', 5, 1);
...
-- Records of train
-- ----------------------------
INSERT INTO `train` VALUES (1, '2024-05-21', '车牌代办-保险代办', '要去车管所', 2);
INSERT INTO `train` VALUES (2, '2024-06-22', '车牌代办', '车管所', 3);
INSERT INTO `train` VALUES (3, '2024-06-13', '验证代办', '验证所', 25);
INSERT INTO `train` VALUES (4, '2024-07-20', '落户代办', '落户所', 1);
INSERT INTO `train` VALUES (5, '2024-06-26', '保险代办-验证代办', '保险验证所', 2);
INSERT INTO `train` VALUES (6, '2024-06-30', '保险代办-验证代办', '保险验证所', 5);
...
-- Records of travel
-- ----------------------------
INSERT INTO `travel` VALUES (1, '2024-07-20', '瑞士', 1234, 1);
INSERT INTO `travel` VALUES (2, '2024-06-15', '揭阳', 1080, 3);
INSERT INTO `travel` VALUES (3, '2024-06-05', '青岛', 1111, 5);
